...
def test_mask_sd(batch_size, model_mask_sd):
        ...
        mask_logits, sd = restore_see_layer(orig=test_set, input_name='x', model_name=model_mask_sd,
                                                                                var_name=['train_mask/sigmoid_output', 'mask_sd/mask_conv_layer/sd_y_pred'])
...
if __name__ == "__main__":
        ...
        optimize(num_epochs=20, save_model=True,save_name=single_patch_model,restore_model=restore_model,restore_name=single_patch_model)
