...
#    total_imgs = 20000000
    ...
    save_model = True
    save_name = model20m_sr
    restore_model = False
    restore_name = model20m_sr

    session = tf.Session()
    session.run(tf.global_variables_initializer())
    optimize(1, train_batch_size, save_model=True, save_name=model20m_sr,
    restore_model=False, restore_name=model20m_sr)
