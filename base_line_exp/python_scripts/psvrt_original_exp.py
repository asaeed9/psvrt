...
def test_mask_sd(batch_size, model_mask_sd):
        ...
        test_set, mask_test_labels, _, _, test_labels = generate_batch(batch_size, img_shape, item_size, nitems, 'SD')
...
if __name__ == "__main__":
        ...
        optimize(num_epochs=20, save_model=save_model, save_name=save_name, restore_model=restore_model,
