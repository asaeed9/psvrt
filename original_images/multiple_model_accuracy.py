    ...
    with mask_sd_graph.as_default():
        ...
        for i in range(0, num_epochs):
            ...
            while end_batch < total_imgs:
                ...
                train_mask(save_model, restore_model, modelleft, left_mask_saver, session_left, end_batch, train_data,
                           left_mask)
                train_mask(save_model, restore_model, modelright, right_mask_saver, session_right, end_batch,
